...
const Projects = () => {
  // Verifica se há exatamente 2 projetos
  const isTwoProjects = projectsData.length === 2;
      ...
      <div className="container mx-auto">
        ...
        <div
          className={`grid gap-5 ${
            isTwoProjects ? 'grid-cols-1 md:grid-cols-2' : 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3'
          }`}
        >
          {projectsData.map((project, index) => (
            ...
            >
              ...
              <a
                ...
                className={`underline ${project.borderColor.replace('border', 'text')}`}
              >
                Visualizar projeto
              </a>
            </article>
