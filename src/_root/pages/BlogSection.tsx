      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
          {blogs.map((blog, index) => (
            ...
            >
              <div>
                <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 text-blue-400">{blog.title}</h3>
                <p className="text-sm sm:text-base text-gray-300 mb-4 sm:mb-5 leading-relaxed">{blog.description}</p>
              </div>
