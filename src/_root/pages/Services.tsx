      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <article className="bg-gray-900 p-6 rounded-lg flex flex-col items-center transition-transform transform hover:scale-105 hover:shadow-lg">
            <img src="/assets/icons/icon-design.svg" alt="ícone layers" className="mb-4 w-16 h-16" />
            <h3 className="text-2xl font-bold mb-2 text-center">UI Design</h3>
          ...
          <article className="bg-gray-900 p-6 rounded-lg flex flex-col items-center transition-transform transform hover:scale-105 hover:shadow-lg">
            <img src="/assets/icons/icon-front.svg" alt="ícone código" className="mb-4 w-16 h-16" />
          ...
          <article className="bg-gray-900 p-6 rounded-lg flex flex-col items-center transition-transform transform hover:scale-105 hover:shadow-lg">
            <img src="/assets/icons/icon-consulting.svg" alt="ícone consultoria" className="mb-4 w-16 h-16" />
